...
<form action="{{ route('cosecha.update', $cosecha) }}" method="POST" id="formEditarCosecha">
    @csrf
    @method('PUT')
        ...
        <div class="row">
                ...
                <select name="cultivo_id" id="cosecha_cultivo_id" class="form-select" required>
                    ...
                    @foreach($cultivos as $c)
                        <option value="{{ $c->id }}" data-unidad="{{ $c->unidad_medida }}" data-estado="{{ $c->estado }}"
                            {{ old('cultivo_id', $cosecha->cultivo_id) == $c->id ? 'selected' : '' }}>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" id="cosecha_unidad_medida" name="unidad_medida"
                    ...
                    value="{{ old('unidad_medida', $cosecha->unidad_medida) }}">
            </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" step="0.001" id="cosecha_cantidad_neta"
                    ...
                    value="{{ old('cantidad_neta', $cosecha->cantidad_neta) }}">
            </div>
            ...
            <div class="col-md-8 mb-3">
                ...
                <textarea name="observaciones" class="form-control" rows="2">{{ old('observaciones', $cosecha->observaciones) }}</textarea>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function actualizarEstadoCultivo() {
        ...
        const submitButton = document.querySelector('#formEditarCosecha button[type=submit]');
