...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>{{ $titulo }}</h1>
        <p class="text-muted mb-0">Listado resumido de órdenes.</p>
    </div>
            ...
            <div class="card-body pt-3">
                <div class="agro-table-toolbar">
                    ...
                    <div class="agro-table-toolbar-group">
                        <form method="GET" action="{{ route('compras.ordenes.report') }}" class="agro-toolbar-inline-form">
                    ...
                    <div class="agro-toolbar-actions">
                        <a href="{{ route('compras.solicitudes.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-list me-1"></i> Solicitudes</a>
                    </div>
                </div>
                        ...
                        <tbody>
                            @forelse($ordenes as $orden)
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-semibold">{{ $orden->recepcion_estado_label }}</div>
                                    </td>
                                    <td>
                                        <a href="{{ route('compras.ordenes.show', $orden) }}" class="btn btn-sm btn-outline-primary">Ver</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted py-4">No hay órdenes registradas para ese filtro.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
