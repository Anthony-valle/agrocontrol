...
<main id="main" class="main">
    ...
    <section class="section">
            ...
            <div class="card-body p-4">
                <form method="GET" action="{{ route('reporteria.lotes') }}" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-5 d-flex gap-2">
                        ...
                        <a href="{{ route('reporteria.lotes.excel', request()->query()) }}" class="btn btn-success">Excel</a>
                        <a href="{{ route('reporteria.lotes.pdf', request()->query()) }}" class="btn btn-danger">PDF</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-3"><div class="card border-0 shadow-sm h-100"><div class="card-body"><small class="text-muted text-uppercase fw-bold">Lotes</small><h3 class="mt-2 mb-0">{{ agro_number($metricas['lotes']) }}</h3></div></div></div>
            <div class="col-md-3"><div class="card border-0 shadow-sm h-100"><div class="card-body"><small class="text-muted text-uppercase fw-bold">Área total</small><h3 class="mt-2 mb-0">{{ agro_number($metricas['area_total'], 2) }}</h3></div></div></div>
            ...
            <div class="col-md-3"><div class="card border-0 shadow-sm h-100"><div class="card-body"><small class="text-muted text-uppercase fw-bold">Cosecha neta</small><h3 class="mt-2 mb-0">{{ agro_number($metricas['cosecha_neta'], 2) }}</h3></div></div></div>
        </div>
