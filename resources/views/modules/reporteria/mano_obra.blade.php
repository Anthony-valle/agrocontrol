...
<main id="main" class="main">
    ...
    <section class="section">
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-3"><div class="card border-0 shadow-sm h-100"><div class="card-body"><small class="text-muted text-uppercase fw-bold">Ejecutado</small><h3 class="mt-2 mb-0 text-warning">{{ agro_number($metricas['ejecutado'], 2) }} Lps</h3></div></div></div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-xl-7">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-header bg-white border-0 pb-0"><h5 class="card-title mb-0">Ejecución registrada</h5></div>
                    <div class="card-body pt-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                <thead class="table-light"><tr><th>#</th><th>Fecha</th><th>Cultivo</th><th>Descripción</th><th>Cantidad</th><th>Subtotal</th></tr></thead>
                                <tbody>
