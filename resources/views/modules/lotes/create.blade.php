<form action="{{ route('lotes.store') }}" method="POST">
    ...
    <div class="modal-header bg-primary text-white border-0">
        <h5 class="modal-title fw-semibold">Nuevo Lote</h5>
    ...
    <div class="modal-body px-4 py-3 lote-modal-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" id="area" name="area" class="form-control" readonly required>
                <div class="lote-metric-list">
                    <small id="area-label">0.00 Ha</small>
                    <small id="perimetro-label" class="text-muted">Perímetro: 0.00 m</small>
                    <small class="text-muted d-block mt-1 map-manual-hint d-none">Sin mapa puedes ingresar el área manualmente.</small>
                </div>
            </div>
            ...
            <div class="col-md-12 lote-map-section">
                ...
                <div class="alert alert-warning d-none map-unavailable-alert mb-3">
                    Google Maps no está disponible en este momento. Puedes guardar el lote ingresando el área manualmente; el polígono quedará vacío.
                </div>
